(function($) {
	$(document).ready(function(e) {
        ...
        $('div#da-unit-datatable-numberpaging_filter input').focus();

        // make the text field ready for the next input
        $("div#da-unit-datatable-numberpaging_filter input").keypress(function(event) {
            if(event.keyCode == 13) {
                this.select();
            }
        });
        ...
        $('#nav-submenu').empty();
        $('#nav-submenu').html('<span>Satuan</span>');

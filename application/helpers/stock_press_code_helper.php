...
if (!function_exists('stock_press_code_generator')) {
    function stock_press_code_generator($category_id) {
        $max_code_length = 7;
        ...
        if(empty($category_detail['prefix'])){
            ...
            if($prefix_length > $max_category_prefix_length){
                ...
                $stock_code = $category_detail['prefix'];
                ...
                if($stock_code_length > $max_code_length){
                    ...
                    do{
                        ...
                        $duplicate_check = $CI->kirimpress_model->get_stock_by_stock_code($generated_stock_code);

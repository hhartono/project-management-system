                        ...
                        <table id="da-purchaseorder-receive-datatable-numberpaging" class="da-table">
                            ...
                            <tbody>
                                <?php foreach($purchaseorder_details as $each_purchaseorder_detail): ?>
                                    <tr>
                                        <td class="database-id" name="item_id"><?php echo $each_purchaseorder_detail['item_id']; ?></td>
                                        ...
                                        <td class="quantity-received-row" name="quantity_received">
                                            <?php if($each_purchaseorder_detail['quantity'] > $each_purchaseorder_detail['quantity_received']){ ?>
                                                <input name="quantity_received_input" type="text" class="span6" value="<?php echo ($each_purchaseorder_detail['quantity'] - $each_purchaseorder_detail['quantity_received']); ?>">&nbsp; 
                                        ...
                                        <td class="price-row" name="quantity_convert">
                                            <p>1 <?php foreach ($units as $units) {
                                                    echo $units['unit_name'];
                                                } ?> = </p><?php if($each_purchaseorder_detail['quantity'] > $each_purchaseorder_detail['quantity_received']){ ?>
                                                <input name="quantity_convert_input" type="text" class="span6" value="<?php echo $each_purchaseorder_detail['convert']; ?>">&nbsp; <?php echo $each_purchaseorder_detail['unit_name']; ?>
                                            <?php }else{
                                                echo "Sudah Diterima";
                                            } ?>
                                        </td>

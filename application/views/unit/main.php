            ...
            <div id="da-content-wrap" class="clearfix">
                ...
                <div id="da-content-area">
                                    ...
                                    <table id="da-unit-datatable-numberpaging" class="da-table"">
                                        ...
                                        <tbody>
                                            <?php foreach($units as $each_unit): ?>
                                                <tr>
                                                    <td class="abbreviation-row"><?php echo !empty($each_unit['abbreviation']) ? $each_unit['abbreviation'] : "-"; ?></td>
                                                    <td class="name-row"><?php echo !empty($each_unit['name']) ? $each_unit['name'] : "-"; ?></td>
                                                    <td class="notes-row"><?php echo !empty($each_unit['notes']) ? $each_unit['notes'] : "-"; ?></td>
                                                    <?php if ((isset($access['edit']) && $access['edit']) || (isset($access['delete']) && $access['delete'])): ?>
                                                        <td class="da-icon-column">
                                                            <?php if(isset($access['edit']) && $access['edit']): ?>
                                                                <a class="da-unit-edit-dialog" href="#"><i class="icol-pencil"></i></a>
                                                            <?php endif; ?>
                    ...
                    <div id="da-unit-edit-form-div" class="form-container">
                        <form id="da-unit-edit-form-val" class="da-form" action="/unit/edit_unit" method="post">

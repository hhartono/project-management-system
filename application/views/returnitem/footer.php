    ...
    <!-- JS Table -->
    <script src="/assets/js/custom/returnitem/returnitem.modal.js"></script>
    <script src="/assets/js/custom/returnitem/returnitem.tables.js"></script>
    ...
    $(document).ready(function(){
        $("#project_id").change(function(){
            var project_id = $("#project_id").val();
                $.ajax({
                    type: "POST",
                    url : "<?php echo base_url(); ?>returnitem/get_sub_project",
